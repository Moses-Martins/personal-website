        ...
        <>
            ...
            <main className="flex-grow">
                <section className="mt-7.5 mb-27">
                    <ArticleCard title="You Don&apos;t Need to Memorize Everything to Be a Great Developer" imagesrc="/memorizeArticle.jpeg" subtitle="Master Development Through Understanding, Not Memory" date="Oct 29, 2025" readTime="4 min" articleLink="https://medium.com/@mosesmartins/you-dont-need-to-memorize-everything-to-be-a-great-developer-a8c49faa5966" />
